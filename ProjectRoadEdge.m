I = imread('/Users/advi/Downloads/motionProfile99.tiff');
...
if meanIntensityValue < 50 || height > 4000
    ...
    lines = houghlines(bi,theta,rho,P,'FillGap',10,'MinLength',7);
    ...
    I=imcrop(I,[83 206 size(I,2) size(I,1)]);
